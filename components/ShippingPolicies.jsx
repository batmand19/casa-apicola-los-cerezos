    ...
    <div className="mt-4 border border-cream-200 rounded-2xl overflow-hidden">
      ...
      {isOpen && (
        <div className="px-5 py-5 text-sm text-earth-600 leading-relaxed space-y-4 bg-white">
          ...
          <p className="text-xs text-earth-400">Contáctanos a <a href="mailto:hcanon@unal.edu.co" className="text-honey-600 hover:text-honey-700 underline">hcanon@unal.edu.co</a> o por <a href="https://wa.me/573208065008" className="text-honey-600 hover:text-honey-700 underline" target="_blank" rel="noopener noreferrer">WhatsApp</a>.</p>
        </div>
      )}
    </div>
  );
